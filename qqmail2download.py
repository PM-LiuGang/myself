...
#    mail_fujian.click()
    ...
    mail_all_download.click() # 有个弊端会把行程单和发票一起打包一起下载，但是会下载全部发票和行程单
