...
eol2 = b'\n\r\n'
boby = '''hello world! 
<h1> from the5fire 《Django 企业开发实战》</h1>  - from {thread_name}
'''
...
def handle_connection(conn, addr):
    ...
    while eol1 not in request and eol2 not in request:
        request += conn.recv(1024)  # 非阻塞模式会报错
...
def main():
    ...
    print('click--->', 'http://127.0.0.1:8000')
    serversocket.setblocking(True)  # 原文是0，必须得修改
